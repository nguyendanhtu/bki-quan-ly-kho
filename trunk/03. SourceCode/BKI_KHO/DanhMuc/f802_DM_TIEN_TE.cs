///************************************************
/// Generated by: DucVT
/// Date: 02/04/2014 02:03:58
/// Goal: Create Form for DM_TIEN_TE
///************************************************
...
namespace BKI_KHO
{
	public class f802_DM_TIEN_TE : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.m_dgv.Size = new System.Drawing.Size(686, 373);
...
,MA_TIEN_TE = 2
		...
		DS_DM_TIEN_TE m_ds = new DS_DM_TIEN_TE();
		US_DM_TIEN_TE m_us = new US_DM_TIEN_TE();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_TIEN_TE.ID, e_col_Number.ID);
			v_htb.Add(DM_TIEN_TE.DANG_THAP_PHAN, e_col_Number.DANG_THAP_PHAN);
			v_htb.Add(DM_TIEN_TE.DOI_TEN, e_col_Number.DOI_TEN);
			v_htb.Add(DM_TIEN_TE.TEN_TIEN_TE, e_col_Number.TEN_TIEN_TE);
			v_htb.Add(DM_TIEN_TE.DANG_CHU, e_col_Number.DANG_CHU);
			v_htb.Add(DM_TIEN_TE.GHI_CHU, e_col_Number.GHI_CHU);
			v_htb.Add(DM_TIEN_TE.KY_HIEU, e_col_Number.KY_HIEU);
			v_htb.Add(DM_TIEN_TE.MA_TIEN_TE, e_col_Number.MA_TIEN_TE);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.DM_TIEN_TE.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_DM_TIEN_TE();			
			m_us.FillDataset(m_ds);
			m_dgv.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_dgv, m_obj_trans);
			m_dgv.Redraw = true;
		}
		private void grid2us_object(US_DM_TIEN_TE i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		private void us_object2grid(US_DM_TIEN_TE i_us
			, int i_grid_row) {
		...
		private void update_dm_tien_te(){			
		...
		private void delete_dm_tien_te(){
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_dgv)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_dgv, m_dgv.Row)) return;
			if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted)  return;
			US_DM_TIEN_TE v_us = new US_DM_TIEN_TE();
...
//
		...
		//
		//
		private void f802_DM_TIEN_TE_Load(object sender, System.EventArgs e) {
			try{

///************************************************
/// Generated by: DucVT
/// Date: 02/04/2014 04:03:02
/// Goal: Create Form for DM_NHOM_HANG
///************************************************
...
namespace BKI_KHO
{
	...
	public class f802_DM_NHOM_HANG : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// m_fg
			// 
			this.m_fg.ColumnInfo = @"5,1,0,0,0,85,Columns:0{Width:13;}	 4{Caption:""Mô tả"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}1{Caption:""ID"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}2{Caption:""ID Nhóm cha"";Visible:True;DataType:System.Decimal;TextAlign:RightCenter;TextAlignFixed:CenterCenter;}3{Caption:""Tên"";Visible:True;DataType:System.String;TextAlign:LeftCenter;TextAlignFixed:CenterCenter;}	";
...
,TEN = 3
		...
		DS_DM_NHOM_HANG m_ds = new DS_DM_NHOM_HANG();
		US_DM_NHOM_HANG m_us = new US_DM_NHOM_HANG();
		#endregion
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_NHOM_HANG.MO_TA, e_col_Number.MO_TA);
			v_htb.Add(DM_NHOM_HANG.ID, e_col_Number.ID);
			v_htb.Add(DM_NHOM_HANG.ID_NHOM_CHA, e_col_Number.ID_NHOM_CHA);
			v_htb.Add(DM_NHOM_HANG.TEN, e_col_Number.TEN);
									
			ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg,v_htb,m_ds.DM_NHOM_HANG.NewRow());
			return v_obj_trans;			
		}
		private void load_data_2_grid(){						
			m_ds = new DS_DM_NHOM_HANG();			
			m_us.FillDataset(m_ds);
			m_fg.Redraw = false;
			CGridUtils.Dataset2C1Grid(m_ds, m_fg, m_obj_trans);
			m_fg.Redraw = true;
		}
		private void grid2us_object(US_DM_NHOM_HANG i_us
			, int i_grid_row) {
			DataRow v_dr;
		...
		//	f801_DM_NHOM_HANG_DE v_fDE = new  f801_DM_NHOM_HANG_DE();								
		//	v_fDE.display();
			load_data_2_grid();
		}

		private void update_dm_nhom_hang(){			
		...
		private void view_dm_nhom_hang(){			
			if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
			grid2us_object(m_us, m_fg.Row);
		//	f801_DM_NHOM_HANG_DE v_fDE = new f801_DM_NHOM_HANG_DE();			
...
//
		...
		//
		//
		private void f801_DM_NHOM_HANG_Load(object sender, System.EventArgs e) {
			try{

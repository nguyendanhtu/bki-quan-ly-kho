...
namespace BKI_KHO
{
	...
	public class f802_DM_NHOM_HANG : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f802_DM_NHOM_HANG));
            ...
            this.Load += new System.EventHandler(this.f802_DM_NHOM_HANG_Load);
...
,TEN = 1
		...
		private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg){
			...
			v_htb.Add(DM_NHOM_HANG.LEVEL_MODE, e_col_Number.LEVEL_MODE);
			v_htb.Add(DM_NHOM_HANG.STT, e_col_Number.STT);
		...
		private void insert_dm_nhom_hang(){			
			f803_DM_NHOM_HANG_DE v_fDE = new  f803_DM_NHOM_HANG_DE();								
		...
		private void view_dm_nhom_hang(){			
			...
			if (!CGridUtils.isValid_NonFixed_RowIndex(m_dgv, m_dgv.Row)) return;
			grid2us_object(m_us, m_dgv.Row);
		//	f802_DM_NHOM_HANG_DE v_fDE = new f802_DM_NHOM_HANG_DE();			
		//	v_fDE.display(m_us);
		}
...
//
		...
		//
		//
		private void f802_DM_NHOM_HANG_Load(object sender, System.EventArgs e) {
			try{

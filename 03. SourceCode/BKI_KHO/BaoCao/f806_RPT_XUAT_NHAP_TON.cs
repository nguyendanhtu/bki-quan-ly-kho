///************************************************
/// Generated by: DucVT
/// Date: 25/04/2014 09:20:28
/// Goal: Create Form for RPT_XUAT_NHAP_TON
///************************************************
...
namespace BKI_KHO
{
    ...
    public class f806_RPT_XUAT_NHAP_TON : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f806_RPT_XUAT_NHAP_TON));
            ...
            this.m_dgv.Size = new System.Drawing.Size(686, 237);
...
,
        ...
        DS_RPT_XUAT_NHAP_TON m_ds = new DS_RPT_XUAT_NHAP_TON();
        US_RPT_XUAT_NHAP_TON m_us = new US_RPT_XUAT_NHAP_TON();
        ...
        private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg)
        {
            ...
            v_htb.Add(RPT_XUAT_NHAP_TON.PHAT_SINH_GIAM, e_col_Number.PHAT_SINH_GIAM);
            v_htb.Add(RPT_XUAT_NHAP_TON.SO_DU_DAU_KY, e_col_Number.SO_DU_DAU_KY);
            v_htb.Add(RPT_XUAT_NHAP_TON.PHAT_SINH_TANG, e_col_Number.PHAT_SINH_TANG);
            v_htb.Add(RPT_XUAT_NHAP_TON.SO_DU_CUOI_KY, e_col_Number.SO_DU_CUOI_KY);
            v_htb.Add(RPT_XUAT_NHAP_TON.TEN_NHOM_HANG, e_col_Number.TEN_NHOM_HANG);

            ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg, v_htb, m_ds.RPT_XUAT_NHAP_TON.NewRow());
            return v_obj_trans;
        }
        private void load_data_2_grid()
        {
            m_ds = new DS_RPT_XUAT_NHAP_TON();
        ...
        private void grid2us_object(US_RPT_XUAT_NHAP_TON i_us
            , int i_grid_row)
        {
            DataRow v_dr;
        ...
        private void us_object2grid(US_RPT_XUAT_NHAP_TON i_us
            , int i_grid_row)
        {
        ...
        private void insert_rpt_xuat_nhap_ton()
        {
            //	f806_RPT_XUAT_NHAP_TON_DE v_fDE = new  f806_RPT_XUAT_NHAP_TON_DE();								
            //	v_fDE.display();
            load_data_2_grid();
        }

        private void update_rpt_xuat_nhap_ton()
        {
        ...
        private void delete_rpt_xuat_nhap_ton()
        {
            if (!CGridUtils.IsThere_Any_NonFixed_Row(m_dgv)) return;
            if (!CGridUtils.isValid_NonFixed_RowIndex(m_dgv, m_dgv.Row)) return;
            if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted) return;
            US_RPT_XUAT_NHAP_TON v_us = new US_RPT_XUAT_NHAP_TON();
        ...
        private void view_rpt_xuat_nhap_ton()
        {
            if (!CGridUtils.IsThere_Any_NonFixed_Row(m_dgv)) return;
            if (!CGridUtils.isValid_NonFixed_RowIndex(m_dgv, m_dgv.Row)) return;
            grid2us_object(m_us, m_dgv.Row);
        ...
        //
        //
        private void f806_RPT_XUAT_NHAP_TON_Load(object sender, System.EventArgs e)
        {
            try
            {

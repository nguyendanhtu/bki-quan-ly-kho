...
/// Date: 21/04/2014 07:12:54
/// Goal: Create Form for V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN
///************************************************
...
namespace BKI_KHO
{
    ...
    public class f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN : System.Windows.Forms.Form
    {
        ...
        public f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN()
        {
            //
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN));
            ...
            this.m_pnl_out_place_dm.Location = new System.Drawing.Point(0, 473);
            this.m_pnl_out_place_dm.Name = "m_pnl_out_place_dm";
            this.m_pnl_out_place_dm.Padding = new System.Windows.Forms.Padding(4);
            this.m_pnl_out_place_dm.Size = new System.Drawing.Size(1098, 36);
            ...
            this.m_cmd_update.Location = new System.Drawing.Point(750, 4);
            ...
            this.m_cmd_export_excel.Size = new System.Drawing.Size(159, 28);
            this.m_cmd_export_excel.TabIndex = 21;
            this.m_cmd_export_excel.Text = "Xuất Excel";
            this.m_cmd_export_excel.Visible = false;
            // 
            // m_cmd_delete
            // 
            ...
            this.m_cmd_delete.Location = new System.Drawing.Point(838, 4);
            ...
            this.m_cmd_exit.Location = new System.Drawing.Point(926, 4);
            this.m_cmd_exit.Name = "m_cmd_exit";
            this.m_cmd_exit.Size = new System.Drawing.Size(168, 28);
            ...
            this.m_fg.Size = new System.Drawing.Size(1098, 319);
            ...
            this.panel1.Size = new System.Drawing.Size(1098, 149);
            this.panel1.TabIndex = 21;
            // 
            // m_lbl_count_record
            // 
            this.m_lbl_count_record.AutoSize = true;
            this.m_lbl_count_record.Location = new System.Drawing.Point(44, 119);
            this.m_lbl_count_record.Name = "m_lbl_count_record";
            this.m_lbl_count_record.Size = new System.Drawing.Size(0, 13);
            this.m_lbl_count_record.TabIndex = 26;
            // 
            // m_cmd_search
            // 
            ...
            this.m_cmd_search.Location = new System.Drawing.Point(926, 83);
            this.m_cmd_search.Name = "m_cmd_search";
            this.m_cmd_search.Size = new System.Drawing.Size(122, 28);
            this.m_cmd_search.TabIndex = 25;
            this.m_cmd_search.Text = "Lập báo cáo";
            // 
            // m_txt_search
            // 
            ...
            this.m_txt_search.Size = new System.Drawing.Size(737, 20);
            ...
            this.m_dat_tu_ngay.Location = new System.Drawing.Point(384, 45);
            ...
            this.m_lbl_title.Size = new System.Drawing.Size(1098, 31);
            ...
            // 
            // f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN
            // 
...
,
        ...
        DS_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN m_ds = new DS_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN();
        US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN m_us = new US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN();
        #endregion
        ...
        private void format_controls()
        {
            ...
            m_fg.Tree.Column = (int)e_col_Number.MA_NHAN_VIEN;
        ...
        private void format_fixed_rows_in_grid()
        {
            ...
            m_fg.Cols[(int)e_col_Number.MA_NHAN_VIEN].AllowMerging = true;
            m_fg[0, (int)e_col_Number.MA_NHAN_VIEN] = "Mã nhân viên";
            m_fg[1, (int)e_col_Number.MA_NHAN_VIEN] = "Mã nhân viên";

            m_fg.Rows[0].AllowMerging = true;
            m_fg[0, (int)e_col_Number.NHAP] = "Tổng nguồn tiền nhập/xuất (VNĐ)";
            m_fg[0, (int)e_col_Number.XUAT] = "Tổng nguồn tiền nhập/xuất (VNĐ)";
            m_fg[0, (int)e_col_Number.SUA_CHUA] = "Tổng nguồn tiền nhập/xuất (VNĐ)";

            m_fg[1, (int)e_col_Number.NHAP] = "Giá trị hàng nhập";
            m_fg[1, (int)e_col_Number.XUAT] = "Doanh thu bán hàng";
            m_fg[1, (int)e_col_Number.SUA_CHUA] = "Doanh thu sửa chữa";
        }
        ...
        private ITransferDataRow get_trans_object(C1.Win.C1FlexGrid.C1FlexGrid i_fg)
        {
            ...
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.MA_NHAN_VIEN, e_col_Number.MA_NHAN_VIEN);
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.HO_DEM, e_col_Number.HO_DEM);
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.NHAP, e_col_Number.NHAP);
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.XUAT, e_col_Number.XUAT);
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.SUA_CHUA, e_col_Number.SUA_CHUA);
            v_htb.Add(V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.TEN, e_col_Number.TEN);

            ITransferDataRow v_obj_trans = new CC1TransferDataRow(i_fg, v_htb, m_ds.V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN.NewRow());
            return v_obj_trans;
        }
        private void load_data_2_grid()
        {
            m_ds = new DS_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN();
            m_us.FillDatasetByNgayThang(m_ds, m_dat_tu_ngay.Value, m_dat_den_ngay.Value, m_txt_search.Text);
            m_fg.Redraw = false;
            ...
            m_fg.Subtotal(
                ...
                , 0
                , -1
                , (int)e_col_Number.SUA_CHUA
                , "Tổng");

            m_fg.Redraw = true;
            m_lbl_count_record.Text = string.Format("Có {0} bản ghi", m_ds.Tables[0].Rows.Count);
        }
        private void grid2us_object(US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN i_us, int i_grid_row)
        {
            DataRow v_dr;
        ...
        private void us_object2grid(US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN i_us, int i_grid_row)
        {
        ...
        private void insert_v_bao_cao_doanh_thu_theo_nhan_vien()
        {
            //	f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN_DE v_fDE = new  f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN_DE();								
            //	v_fDE.display();
            load_data_2_grid();
        }

        private void update_v_bao_cao_doanh_thu_theo_nhan_vien()
        {
        ...
        private void delete_v_bao_cao_doanh_thu_theo_nhan_vien()
        {
            if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
            if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
            if (BaseMessages.askUser_DataCouldBeDeleted(8) != BaseMessages.IsDataCouldBeDeleted.CouldBeDeleted) return;
            US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN v_us = new US_V_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN();
        ...
        private void view_v_bao_cao_doanh_thu_theo_nhan_vien()
        {
            if (!CGridUtils.IsThere_Any_NonFixed_Row(m_fg)) return;
            if (!CGridUtils.isValid_NonFixed_RowIndex(m_fg, m_fg.Row)) return;
            grid2us_object(m_us, m_fg.Row);
        ...
        private void auto_suggest_text()
        {
            ...
            {
                v_acsc_search.Add(dr[DM_NHAN_VIEN.HO_DEM].ToString() + " " + dr[DM_NHAN_VIEN.TEN].ToString());
            }
            m_txt_search.AutoCompleteCustomSource = v_acsc_search;
        }
        #endregion
        ...
        private void f702_BAO_CAO_DOANH_THU_THEO_NHAN_VIEN_Load(object sender, System.EventArgs e)
        {
            try
            {
        ...
        private void m_cmd_insert_Click(object sender, EventArgs e)
        {
            try
            {
                insert_v_bao_cao_doanh_thu_theo_nhan_vien();
            }
            catch (Exception v_e)
            {
                CSystemLog_301.ExceptionHandle(v_e);
        ...
        private void m_cmd_update_Click(object sender, EventArgs e)
        {
            try
            {
                update_v_bao_cao_doanh_thu_theo_nhan_vien();
            }
            catch (Exception v_e)
            {
                CSystemLog_301.ExceptionHandle(v_e);
        ...
        private void m_cmd_delete_Click(object sender, EventArgs e)
        {
            try
            {
                delete_v_bao_cao_doanh_thu_theo_nhan_vien();
            }
            catch (Exception v_e)
            {
                CSystemLog_301.ExceptionHandle(v_e);
        ...
        private void m_cmd_view_Click(object sender, EventArgs e)
        {
            try
            {
                view_v_bao_cao_doanh_thu_theo_nhan_vien();
            }
            catch (Exception v_e)
            {
                CSystemLog_301.ExceptionHandle(v_e);

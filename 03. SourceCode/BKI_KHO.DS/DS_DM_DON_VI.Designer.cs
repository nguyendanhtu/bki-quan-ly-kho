...
namespace BKI_KHO.DS.DS_DM_DON_VITableAdapters {
    ...
    public partial class DM_DON_VITableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[DM_DON_VI] WHERE (([ID] = @Original_ID) AND ([MA] = @Original_" +
                "MA) AND ((@IsNull_TEN = 1 AND [TEN] IS NULL) OR ([TEN] = @Original_TEN)) AND ((@" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DM_DON_VI] SET [MA] = @MA, [TEN] = @TEN, [GHI_CHU] = @GHI_CHU WHERE (([ID] = @Original_ID) AND ([MA] = @Original_MA) AND ((@IsNull_TEN = 1 AND [TEN] IS NULL) OR ([TEN] = @Original_TEN)) AND ((@IsNull_GHI_CHU = 1 AND [GHI_CHU] IS NULL) OR ([GHI_CHU] = @Original_GHI_CHU)));
